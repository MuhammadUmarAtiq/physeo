...
export const columns = [
  ...
  },
  {
    ...
    header: "Coupons Code",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("couponsCode")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("assignedUsers")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("appliedUsers")}</div>
    ),
  },
  {
    ...
    header: "Start Data",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("startData")}</div>
    ),
  },
  {
    accessorKey: "endDate",
