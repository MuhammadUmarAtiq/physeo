...
export const columns = [
  {
    ...
    header: "Coupon Code",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("coupons_code")}</div>
    ),
  },
  {
    accessorKey: "types",
    header: "Types",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("types")}</div>
    ),
  },
  {
    accessorKey: "plan",
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("assigned_user")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("applied_user")}</div>
    ),
  },
  {
    accessorKey: "name",
...
export function StripeCoupons() {
  ...
  return <RecordTable data={data} columns={columns} />;
}
